...
namespace UnityFoundation.Editor.Hierarchy
{
    public static class EditorColors
    {
        ...
        /// </summary>
        public static Color32 Background {
            get { return EditorGUIUtility.isProSkin ? darkBackground : lightBackground; }
        }
        /// <summary>
        ...
        /// </summary>
        public static Color32 Text {
            get { return EditorGUIUtility.isProSkin ? darkText : lightText; }
        }
        /// <summary>
        ...
        /// </summary>
        public static Color32 TextHighlighted {
            get {
                return EditorGUIUtility.isProSkin
                    ? darkTextHighlighted : lightTextHighlighted;
            }
        }
        /// <summary>
        ...
        public static Color GetDefaultSelectedBackgroundColor()
        {
            return EditorUtils.IsHierarchyFocused
                ? ObjectSelectedWindowFocusedBackground
                : ObjectSelectedBackground;
        }

        /// <summary>
        /// Returns the correct hierarchy text color depending on the context.
        /// </summary>
        public static Color32 GetDefaultSelectedTextColor(bool objectIsEnabled)
        {
            var textHighlighted = IsTextHighlighted(true, objectIsEnabled);
            var color = textHighlighted ? TextHighlighted : Text;
        ...
        /// </summary>
        public static bool IsTextHighlighted(bool objectIsSelected, bool objectIsEnabled)
        {
            return EditorUtils.IsHierarchyFocused
                && objectIsSelected
                && objectIsEnabled;
