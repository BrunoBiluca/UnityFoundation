// GENERATED AUTOMATICALLY FROM 'Assets/UnityFoundation/Systems/Character3D/InputSystem/ThridPersonInputActions.inputactions'
...
{
    public class @ThridPersonInputActions : IInputActionCollection, IDisposable
    {
